...
exports.getHolidayOccurrence = getHolidayOccurrence;
exports.getUpcomingHolidays = getUpcomingHolidays;
exports.getNextHoliday = getNextHoliday;
exports.getHolidaysToPushToday = getHolidaysToPushToday;
...
function todayIrkutskUtc(now = new Date()) {
...
function holidayDateUtc(h, year) {
    return new Date(Date.UTC(year, h.month - 1, h.day));
}
function getHolidayOccurrence(h, now = new Date()) {
...
function getUpcomingHolidays(now = new Date()) {
    return exports.HOLIDAYS
...
function getHolidaysToPushToday(now = new Date()) {
