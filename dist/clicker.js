...
exports.MILESTONES = exports.SQUAD_NAME_MAX = exports.SQUAD_NAME_MIN = exports.SQUAD_MAX_MEMBERS = exports.SQUAD_CREATE_COST = exports.SQUAD_BANK_TARGET_CAP = exports.SQUAD_BANK_TARGET_FLOOR = exports.SQUAD_BANK_TARGET_PCT = exports.SQUAD_BANK_DAY_CAP = exports.SQUAD_BANK_MIN_DONATE = exports.SQUAD_BANK_MULT = exports.CASE_DAILY_ROLL_LIMIT = exports.FTUE_STEPS = exports.cardProfit = exports.cardPrice = exports.CARD_PROFIT_GROWTH = exports.CARD_PRICE_GROWTH = exports.energyMaxFor = exports.SQUADS = exports.CARDS = exports.CARD_CATS = exports.WEEKLY_PRIZES = exports.WEEKLY_PRIZES_ENABLED = exports.REWARDS = exports.REWARDS_ENABLED = exports.LEAGUES = exports.ACHIEVEMENTS = exports.TASKS = exports.SOCIAL = exports.EVENTS_ENABLED = exports.weekKey = exports.todayIrkutsk = exports.BUSINESS_MAX_LEVEL = exports.SWEET_TAP_MULT = exports.SWEET_TAP_EVERY = exports.GIFTS_ENABLED = void 0;
exports.sweetCritsIn = sweetCritsIn;
exports.comboMilestonesIn = comboMilestonesIn;
exports.tapUnitGain = tapUnitGain;
exports.settlePassiveIncome = settlePassiveIncome;
exports.settleEnergyRegeneration = settleEnergyRegeneration;
exports.weekMonday = weekMonday;
exports.passiveEarnedInCurrentWeek = passiveEarnedInCurrentWeek;
exports.closedWeekSeasonPoints = closedWeekSeasonPoints;
exports.eventMultiplierAt = eventMultiplierAt;
exports.settlePassiveIncomeAcrossEvents = settlePassiveIncomeAcrossEvents;
exports.passiveEarnedInCurrentWeekAcrossEvents = passiveEarnedInCurrentWeekAcrossEvents;
exports.effectiveDailyStreak = effectiveDailyStreak;
exports.effectiveCareerLevel = effectiveCareerLevel;
exports.nextNeedForLevel = nextNeedForLevel;
exports.comboHitsIncludingMaxed = comboHitsIncludingMaxed;
exports.initClickerSchema = initClickerSchema;
exports.deleteClickerProfile = deleteClickerProfile;
exports.resetClickerProgress = resetClickerProgress;
exports.normalizeAdminPassiveBonus = normalizeAdminPassiveBonus;
exports.settleClickerBeforeIncomeChange = settleClickerBeforeIncomeChange;
exports.refreshEnergyFor = refreshEnergyFor;
exports.getClicker = getClicker;
exports.tapClicker = tapClicker;
exports.prestigeReset = prestigeReset;
exports.buyClicker = buyClicker;
exports.claimDaily = claimDaily;
exports.claimCombo = claimCombo;
exports.claimCipher = claimCipher;
exports.getFtue = getFtue;
exports.claimFtue = claimFtue;
exports.redeemCode = redeemCode;
exports.createGameAttempt = createGameAttempt;
exports.gameAttemptDay = gameAttemptDay;
exports.dailyClaimRejection = dailyClaimRejection;
exports.claimRain = claimRain;
exports.gameParticipationReward = gameParticipationReward;
exports.claimGame = claimGame;
exports.openChest = openChest;
exports.openCase = openCase;
exports.claimBonus = claimBonus;
exports.boostClicker = boostClicker;
exports.getTop = getTop;
exports.closeWeeklySeason = closeWeeklySeason;
exports.pushWeeklyWinners = pushWeeklyWinners;
exports.squadBankTargetFrom = squadBankTargetFrom;
exports.squadBankClamp = squadBankClamp;
exports.initSquadBankSchema = initSquadBankSchema;
exports.squadBankStatus = squadBankStatus;
exports.setClickerPushService = setClickerPushService;
exports.donateSquadBank = donateSquadBank;
exports._clearSquadBankCache = _clearSquadBankCache;
exports.sanitizeSquadName = sanitizeSquadName;
exports.initCustomSquadSchema = initCustomSquadSchema;
exports.createSquad = createSquad;
exports.joinSquadByCode = joinSquadByCode;
exports.requestJoinSquad = requestJoinSquad;
exports.listSquadRequests = listSquadRequests;
exports.decideSquadRequest = decideSquadRequest;
exports.getSquads = getSquads;
exports.getSquadMembers = getSquadMembers;
exports.joinSquad = joinSquad;
exports.isReferralEligibleState = isReferralEligibleState;
exports.registerRef = registerRef;
exports.getRefOrderCandidates = getRefOrderCandidates;
exports.markRefOrderRewarded = markRefOrderRewarded;
exports.welcomePromoShown = welcomePromoShown;
exports.markWelcomePromoShown = markWelcomePromoShown;
exports.markOnboarded = markOnboarded;
exports.migrateGuest = migrateGuest;
exports.getRewards = getRewards;
exports.redeemReward = redeemReward;
exports.addClickerBalance = addClickerBalance;
exports.getAchievements = getAchievements;
exports.getTasks = getTasks;
exports.claimTask = claimTask;
exports.getMilestones = getMilestones;
exports.claimMilestone = claimMilestone;
exports.computePurchaseGrant = computePurchaseGrant;
exports.syncPurchaseBonus = syncPurchaseBonus;
/**
...
exports.GIFTS_ENABLED = process.env.CLICKER_GIFTS_ENABLED === "1";
...
exports.SWEET_TAP_EVERY = 40;
exports.SWEET_TAP_MULT = 8;
/** Сколько «сладких» (кратных SWEET_TAP_EVERY) тапов попало в батч (oldTaps, oldTaps+can]. */
function sweetCritsIn(oldTaps, can) {
    return Math.floor((oldTaps + can) / exports.SWEET_TAP_EVERY) - Math.floor(oldTaps / exports.SWEET_TAP_EVERY);
}
/** Серверный бонус серии: каждый 10-й lifetime-тап даёт ещё один базовый тап. */
function comboMilestonesIn(oldTaps, can) {
    return Math.floor((oldTaps + can) / 10) - Math.floor(oldTaps / 10);
}
/** Целая цена одного обычного тапа — точное зеркало optimistic UI. */
function tapUnitGain(perTap, turbo, globalMult, bankMult) {
...
const tapBuckets = new Map();
function takeTapAllowance(chatId, requested) {
    ...
    if (tapBuckets.size > 10000) {
        for (const [id, b] of tapBuckets)
            if (now - b.ts > 10 * 60000)
                tapBuckets.delete(id);
        if (tapBuckets.size > 10000)
            tapBuckets.delete(tapBuckets.keys().next().value);
    }
    return take;
}
 ...
 */
function settlePassiveIncome(hourlyRate, elapsedSeconds, previousCarry = 0, capHours = PASSIVE_CAP_HOURS) {
 ...
 */
function settleEnergyRegeneration(currentEnergy, energyMax, elapsedSeconds, previousCarry = 0) {
...
exports.todayIrkutsk = irkToday;
// Сезон = неделя по Иркутску (сброс в понедельник 00:00). Ключ — индекс дня-понедельника.
function weekMonday() { const d = Math.floor((Date.now() + 8 * 3600 * 1000) / 86400000); return d - ((d + 3) % 7); }
 ...
 */
function passiveEarnedInCurrentWeek(hourlyRate, lastUpdateMs, nowMs = Date.now(), previousCarry = 0, capHours = PASSIVE_CAP_HOURS) {
...
function closedWeekSeasonPoints(totalEarned, weekBase, currentWeekPassive) {
...
const prestigeMultOf = (p) => 1 + Math.min(Math.max(0, p || 0), PRESTIGE_MAX) * PRESTIGE_BONUS;
// ── Ивенты (#9) ──────────────────────────────────────────────────────────────
...
exports.EVENTS_ENABLED = true;
function eventMultiplierAt(timestampMs) {
    if (!exports.EVENTS_ENABLED || !Number.isFinite(timestampMs))
        return 1;
    const wd = new Date(timestampMs + 8 * 3600 * 1000).getUTCDay();
    return wd === 6 || wd === 0 ? 2 : 1;
}
function activeEvent() {
    if (!exports.EVENTS_ENABLED)
        return null;
    if (eventMultiplierAt(Date.now()) > 1)
        return { id: "weekend", name: "Выходные ×2", mult: 2, endsTs: seasonEndsTs() };
    return null;
}
const eventMult = () => activeEvent()?.mult ?? 1;
// Общий множитель заработка (тап + пассив): престиж × ивент.
const gainMult = (prestige) => prestigeMultOf(prestige) * eventMult();
/** Пассив с учётом событий внутри offline-окна, а не только в момент возврата. */
function settlePassiveIncomeAcrossEvents(baseHourlyRate, lastUpdateMs, nowMs = Date.now(), previousCarry = 0, capHours = PASSIVE_CAP_HOURS) {
    if (!Number.isFinite(lastUpdateMs) || !Number.isFinite(nowMs) || nowMs <= lastUpdateMs) {
...
function passiveEarnedInCurrentWeekAcrossEvents(baseHourlyRate, lastUpdateMs, nowMs = Date.now(), previousCarry = 0, capHours = PASSIVE_CAP_HOURS) {
    if (!Number.isFinite(lastUpdateMs) || !Number.isFinite(nowMs) || nowMs <= lastUpdateMs)
        return 0;
...
exports.TASKS = [
    ...
    { id: "review", name: "Оставить отзыв о «Марии»", icon: "⭐", reward: 5000, type: "link", link: exports.SOCIAL.review },
    { id: "vk", name: "Подписаться на ВК «Мария»", icon: "👍", reward: 4000, type: "link", link: exports.SOCIAL.vk },
...
const ALL_BY_ID = Object.fromEntries([...exports.TASKS, ...exports.ACHIEVEMENTS].map((t) => [t.id, t]));
const dailyReward = (streak) => 250 * Math.min(Math.max(1, streak), 10); // день1=250 … день10+=2500
/** Текущий непрерывный стрик; после пропущенных суток старое значение не показываем. */
function effectiveDailyStreak(lastClaimDate, storedStreak, today = irkToday()) {
...
exports.REWARDS_ENABLED = process.env.CLICKER_REWARDS_ENABLED === "1";
exports.REWARDS = [
...
const REWARD_BY_ID = Object.fromEntries(exports.REWARDS.map((r) => [r.id, r]));
...
exports.WEEKLY_PRIZES_ENABLED = false;
exports.WEEKLY_PRIZES = [
...
const WEEKLY_PRIZE_BY_RANK = Object.fromEntries(exports.WEEKLY_PRIZES.map((p) => [p.rank, p]));
...
const CARD_BY_ID = Object.fromEntries(exports.CARDS.map((c) => [c.id, c]));
...
const SQUAD_IDS = new Set(exports.SQUADS.map((s) => s.id));
const priceMultitap = (lvl) => Math.round(200 * Math.pow(2, lvl));
const priceEnergy = (lvl) => Math.round(300 * Math.pow(2, lvl));
const energyMaxFor = (lvl) => 1000 + 500 * lvl;
exports.energyMaxFor = energyMaxFor;
const perTapFor = (lvl) => 1 + lvl;
...
exports.CARD_PRICE_GROWTH = 1.45;
exports.CARD_PROFIT_GROWTH = 1.25;
const cardPrice = (c, lvl) => Math.round(c.basePrice * Math.pow(exports.CARD_PRICE_GROWTH, lvl));
exports.cardPrice = cardPrice;
const cardProfit = (c, lvl) => lvl <= 0 ? 0 : Math.round(c.baseProfit * (Math.pow(exports.CARD_PROFIT_GROWTH, lvl) - 1) / (exports.CARD_PROFIT_GROWTH - 1));
exports.cardProfit = cardProfit;
...
function dateSeed(day, salt) { let h = 2166136261 >>> 0; const s = day + salt; for (let i = 0; i < s.length; i++) {
    h ^= s.charCodeAt(i);
    h = Math.imul(h, 16777619) >>> 0;
} return h >>> 0; }
function todaysCombo(day) { let h = dateSeed(day, "combo"); const pool2 = exports.CARDS.map((c) => c.id); const pick = []; for (let i = 0; i < 3; i++) {
    h = (Math.imul(h, 1664525) + 1013904223) >>> 0;
    pick.push(pool2.splice(h % pool2.length, 1)[0]);
} return pick; }
...
function parseHits(s) { return s ? s.split(",").filter(Boolean) : []; }
async function initClickerSchema() {
...
async function deleteClickerProfile(chatId) {
    ...
    try {
        ...
        const incomingDuels = await client.query(`SELECT id, from_chat, stake FROM pigeon_duels WHERE to_chat=$1 AND status='open' FOR UPDATE`, [chatId]);
        ...
        const owned = await client.query(`SELECT id FROM squads WHERE owner_chat_id=$1`, [chatId]);
...
async function resetClickerProgress(chatId) {
    const client = await db_1.pool.connect();
    try {
        await client.query("BEGIN");
        await client.query(`SELECT pg_advisory_xact_lock(hashtextextended($1, 0))`, ["pigeon-duels-mutation-v1"]);
        ...
        const openDuels = await client.query(`SELECT id, from_chat, to_chat, stake FROM pigeon_duels
        ...
        for (const duel of openDuels.rows) {
            ...
            await client.query(`UPDATE pigeon_duels SET status=$2, closed_at=NOW() WHERE id=$1`, [duel.id, fromChat === chatId ? "cancelled" : "declined"]);
        }
...
async function readCards(client, chatId) {
...
function normalizeAdminPassiveBonus(value) {
    const n = Math.floor(Number(value));
    return Number.isFinite(n) && n > 0 ? n : 0;
}
function profitPerHour(cl, albumMult = 1, pigeonPassive = 0, bonusProfitPerHour = 0) { let p = Math.max(0, Math.floor(Number(pigeonPassive) || 0)); for (const c of exports.CARDS)
    p += (0, exports.cardProfit)(c, cl[c.id] || 0); return p * albumMult + normalizeAdminPassiveBonus(bonusProfitPerHour); }
function buildState(r, cl, passiveEarned) {
    ...
    const lg = exports.LEAGUES[effLevel - 1];
    ...
    return {
        ...
        balance: Number(r.balance), totalEarned: Number(r.total_earned), energy: r.energy, energyMax: (0, exports.energyMaxFor)(r.energy_limit_level),
        ...
        cards: exports.CARDS.map((c) => { const lv = cl[c.id] || 0; const locked = lv === 0 && !!c.req && lg.level < c.req; const maxed = lv >= exports.BUSINESS_MAX_LEVEL; const currentProfit = (0, exports.cardProfit)(c, lv), profit = maxed ? currentProfit : (0, exports.cardProfit)(c, lv + 1); return { id: c.id, name: c.name, cat: c.cat, level: lv, profit, currentProfit, profitGain: profit - currentProfit, price: maxed ? 0 : (0, exports.cardPrice)(c, lv), req: c.req || 0, locked, maxed }; }),
        ...
        referrals: r.referrals || 0, refCode: String(r.chat_id), refLink: (0, links_1.clickerReferralLink)(Number(r.chat_id)),
        ...
        taps: Number(r.taps || 0), cardsOwned: exports.CARDS.filter((c) => (cl[c.id] || 0) > 0).length,
        onboarded: !!r.onboarded,
        season: { points: r.week_key === (0, exports.weekKey)() ? Math.max(0, Number(r.total_earned) - Number(r.week_base || 0)) : 0, endsTs: seasonEndsTs() },
...
async function refresh(client, chatId) {
    ...
    if (!r.starter_pigeon) {
        const { grantPigeon } = await Promise.resolve().then(() => __importStar(require("./pigeons")));
    ...
    const today = irkToday();
    if (r.boost_date !== today) {
        r.boost_energy_used = 0;
        r.boost_turbo_used = 0;
        r.boost_date = today;
    }
    ...
    const energySettlement = settleEnergyRegeneration(Number(r.energy), (0, exports.energyMaxFor)(r.energy_limit_level), energySecs, Number(r.energy_carry || 0));
    ...
    const { ALBUM_PASSIVE_BONUS, pigeonPassiveBonus } = await Promise.resolve().then(() => __importStar(require("./pigeons")));
    ...
    const bankMult = (await squadBankActive(r.squad || null, client)) ? exports.SQUAD_BANK_MULT : 1;
    ...
    const currentWeekPassive = r.week_key !== wk
        ...
        : 0;
    const passiveSettlement = settlePassiveIncomeAcrossEvents(basePassiveRate, passiveUpdatedMs, passiveNow, Number(r.passive_carry || 0));
    const passive = passiveSettlement.earned;
    if (passive > 0) {
        r.balance = Number(r.balance) + passive;
        r.total_earned = Number(r.total_earned) + passive;
    }
    ...
    if (r.week_key !== wk) {
        if (r.week_key) {
            ...
            await client.query(`INSERT INTO clicker_week_player_stats (week_key, chat_id, squad, points) VALUES ($1,$2,$3,$4)
         ON CONFLICT (week_key, chat_id) DO UPDATE SET
           squad=EXCLUDED.squad, points=GREATEST(clicker_week_player_stats.points, EXCLUDED.points)`, [String(r.week_key), chatId, r.squad || null, closedPoints]);
        }
        r.week_key = wk;
        r.week_base = Math.max(0, Number(r.total_earned) - Math.min(passive, currentWeekPassive));
    }
    const saved = await client.query(`UPDATE clicker_state SET balance=$2, total_earned=$3, energy=$4, boost_energy_used=$5, boost_turbo_used=$6, boost_date=$7, week_key=$8, week_base=$9, updated_at=NOW(), passive_updated_at=NOW(), passive_carry=$10, energy_updated_at=NOW(), energy_carry=$11, state_revision=state_revision+1 WHERE chat_id=$1 RETURNING state_revision`, [chatId, r.balance, r.total_earned, r.energy, r.boost_energy_used, r.boost_turbo_used, r.boost_date, r.week_key, r.week_base, passiveSettlement.carry, energySettlement.carry]);
    ...
    if (lvlNow > (r.notified_level || 0)) {
        if (lvlNow >= 2)
            (0, analytics_1.trackEvent)(chatId, "levelup", { level: lvlNow });
 ...
 */
async function settleClickerBeforeIncomeChange(client, chatId) {
...
async function getClicker(chatId) {
    const client = await db_1.pool.connect();
    try {
        await client.query("BEGIN");
...
async function tapClicker(chatId, taps, _clientComboBonus = 0, requestId = "") {
    ...
    try {
        ...
        if (rid) {
            const previous = await client.query(`SELECT accepted_taps FROM clicker_tap_runs WHERE chat_id=$1 AND request_id=$2`, [chatId, rid]);
        ...
        const earned = (can + crits * (exports.SWEET_TAP_MULT - 1)) * baseTapGain;
        ...
        r.energy -= can * TAP_COST;
        r.balance = Number(r.balance) + earned + earnedCombo;
        r.total_earned = Number(r.total_earned) + earned + earnedCombo;
        r.taps = previousTaps + can;
        await client.query(`UPDATE clicker_state SET balance=$2, total_earned=$3, taps=$4, energy=$5, updated_at=NOW() WHERE chat_id=$1`, [chatId, r.balance, r.total_earned, r.taps, r.energy]);
        if (rid) {
            await client.query(`INSERT INTO clicker_tap_runs (chat_id, request_id, accepted_taps) VALUES ($1,$2,$3)`, [chatId, rid, can]);
        }
        await client.query("COMMIT");
        const state = buildState(r, cl, 0);
 ...
 */
async function prestigeReset(chatId) {
    const client = await db_1.pool.connect();
    try {
        await client.query("BEGIN");
        const { r } = await refresh(client, chatId);
        const lvl = effectiveCareerLevel(Number(r.total_earned), Number(r.max_level));
        if (lvl < PRESTIGE_MIN_LEVEL) {
            await client.query("ROLLBACK");
            return { ok: false, reason: "not_ready" };
        }
        if (Number(r.prestige || 0) >= PRESTIGE_MAX) {
            await client.query("ROLLBACK");
        ...
        const seasonPoints = r.week_key === (0, exports.weekKey)()
            ? Math.max(0, Number(r.total_earned) - Number(r.week_base || 0))
            : 0;
        await client.query(`DELETE FROM clicker_cards WHERE chat_id=$1`, [chatId]);
        await client.query(`UPDATE clicker_state SET balance=0, total_earned=0, energy=$2, multitap_level=0, energy_limit_level=0,
         week_base=$5, week_key=$3, notified_level=0, prestige=$4, max_level=1,
         max_level_prestige=$4, passive_carry=0, energy_carry=0,
         updated_at=NOW(), passive_updated_at=NOW(), energy_updated_at=NOW() WHERE chat_id=$1`, [chatId, (0, exports.energyMaxFor)(0), (0, exports.weekKey)(), newPrestige, -seasonPoints]);
        await client.query("COMMIT");
        (0, analytics_1.trackEvent)(chatId, "prestige", { prestige: newPrestige });
        // отражаем сброс в in-memory строке для ответа (без повторного запроса)
        r.balance = 0;
        r.total_earned = 0;
        r.energy = (0, exports.energyMaxFor)(0);
        r.multitap_level = 0;
        r.energy_limit_level = 0;
        r.week_base = -seasonPoints;
        r.week_key = (0, exports.weekKey)();
        r.notified_level = 0;
        r.prestige = newPrestige;
        r.max_level = 1;
        r.max_level_prestige = newPrestige;
        r.passive_carry = 0;
        r.energy_carry = 0;
...
async function buyClicker(chatId, type, id) {
    const client = await db_1.pool.connect();
    try {
        await client.query("BEGIN");
        const { r, cl } = await refresh(client, chatId);
        let cost = 0;
        if (type === "multitap")
            cost = priceMultitap(r.multitap_level);
        else if (type === "energy")
            cost = priceEnergy(r.energy_limit_level);
        else if (type === "card") {
            const c = id && CARD_BY_ID[id];
            if (!c) {
                await client.query("ROLLBACK");
                return { ok: false, reason: "bad_card" };
            }
            const lv = cl[id] || 0;
            if (lv >= exports.BUSINESS_MAX_LEVEL) {
                await client.query("ROLLBACK");
                return { ok: false, reason: "max_level" };
            }
            if (lv === 0 && c.req && effectiveCareerLevel(Number(r.total_earned), Number(r.max_level)) < c.req) {
                await client.query("ROLLBACK");
                return { ok: false, reason: "locked" };
            }
            cost = (0, exports.cardPrice)(c, lv);
        }
        else {
            await client.query("ROLLBACK");
            return { ok: false, reason: "bad_type" };
        }
        if (Number(r.balance) < cost) {
            await client.query("ROLLBACK");
        ...
        if (type === "multitap")
            ...
            if (todaysCombo(today).includes(id)) {
                ...
                if (!hits.includes(id))
                    hits.push(id);
                r.combo_date = today;
                r.combo_hits = hits.join(",");
            }
        }
        await client.query(`UPDATE clicker_state SET balance=$2, multitap_level=$3, energy_limit_level=$4, combo_date=$5, combo_hits=$6, updated_at=NOW() WHERE chat_id=$1`, [chatId, r.balance, r.multitap_level, r.energy_limit_level, r.combo_date, r.combo_hits]);
        await client.query("COMMIT");
...
async function claimDaily(chatId) {
    ...
    try {
        ...
        const { r, cl } = await refresh(client, chatId);
        const today = irkToday();
        if (r.daily_date === today) {
            await client.query("ROLLBACK");
            return { ok: false, reason: "already" };
        }
        r.daily_streak = effectiveDailyStreak(r.daily_date, r.daily_streak, today) + 1;
        const reward = dailyReward(r.daily_streak);
        r.balance = Number(r.balance) + reward;
        r.total_earned = Number(r.total_earned) + reward;
        r.daily_date = today;
        await client.query(`UPDATE clicker_state SET balance=$2, total_earned=$3, daily_streak=$4, daily_date=$5, updated_at=NOW() WHERE chat_id=$1`, [chatId, r.balance, r.total_earned, r.daily_streak, today]);
        await client.query("COMMIT");
...
async function maybeDropPigeon(chatId, chance, client) {
    if (Math.random() >= chance)
        return undefined;
    const { pickBreed, grantPigeon } = await Promise.resolve().then(() => __importStar(require("./pigeons")));
    const breed = pickBreed(Math.random(), Math.random(), (0, exports.weekKey)(), !!activeEvent());
    return grantPigeon(chatId, breed, client);
}
/** Обновляет snapshot ClickerState после получения новой породы в той же транзакции. */
async function syncPigeonModifiersAfterDrop(r, chatId, drop, client) {
    if (!drop?.isNew)
        return;
    const { ALBUM_PASSIVE_BONUS, hasFullAlbum, pigeonPassiveBonus } = await Promise.resolve().then(() => __importStar(require("./pigeons")));
...
async function claimCombo(chatId) {
    const client = await db_1.pool.connect();
    try {
        await client.query("BEGIN");
        const { r, cl } = await refresh(client, chatId);
        const today = irkToday();
        if (r.combo_claimed === today) {
            await client.query("ROLLBACK");
            return { ok: false, reason: "already" };
        }
        ...
        if (!combo.every((c) => hits.includes(c))) {
            await client.query("ROLLBACK");
            return { ok: false, reason: "not_ready" };
        }
        r.balance = Number(r.balance) + COMBO_REWARD;
        r.total_earned = Number(r.total_earned) + COMBO_REWARD;
        r.combo_claimed = today;
...
async function claimCipher(chatId, guess) {
    const client = await db_1.pool.connect();
    try {
        await client.query("BEGIN");
        const { r, cl } = await refresh(client, chatId);
        const today = irkToday();
        if (r.cipher_date === today) {
            await client.query("ROLLBACK");
            return { ok: false, reason: "already" };
        }
        if (String(guess || "").trim().toUpperCase().replace(/Ё/g, "Е") !== todaysCipher(today)) {
            await client.query("ROLLBACK");
            return { ok: false, reason: "wrong" };
        }
        r.balance = Number(r.balance) + CIPHER_REWARD;
        r.total_earned = Number(r.total_earned) + CIPHER_REWARD;
        r.cipher_date = today;
...
function loadCodes() {
    try {
        const raw = fs.readFileSync(path.resolve("data/clicker-codes.json"), "utf8");
...
const FTUE_ALL_MASK = (1 << exports.FTUE_STEPS.length) - 1;
async function ftueDoneFlags(chatId, db = db_1.pool) {
...
async function getFtue(chatId) {
    const [done, mask] = await Promise.all([
        ftueDoneFlags(chatId),
        db_1.pool.query(`SELECT ftue_claimed FROM clicker_state WHERE chat_id=$1`, [chatId]).then(r => Number(r.rows[0]?.ftue_claimed || 0)),
    ]);
    const steps = exports.FTUE_STEPS.map((s, i) => ({ ...s, done: done[i], claimed: !!(mask & (1 << i)) }));
    return { steps, allClaimed: (mask & FTUE_ALL_MASK) === FTUE_ALL_MASK };
}
async function claimFtue(chatId, stepId) {
    const s = exports.FTUE_STEPS.find(x => x.id === stepId);
    if (!s)
    ...
    try {
        ...
        const upd = await client.query(`UPDATE clicker_state SET ftue_claimed = ftue_claimed | $2, balance = balance + $3,
         total_earned = total_earned + $3, state_revision = state_revision + 1, updated_at=NOW()
        WHERE chat_id=$1 AND (ftue_claimed & $2) = 0 RETURNING balance, state_revision`, [chatId, 1 << stepId, s.reward]);
        if (!upd.rowCount) {
            await client.query("ROLLBACK");
            return { ok: false, reason: "already" };
        }
...
async function redeemCode(chatId, codeInput) {
    const code = String(codeInput || "").trim().toUpperCase().replace(/Ё/g, "Е");
    if (!code)
    ...
    try {
        ...
        const updated = await client.query(`UPDATE clicker_state SET balance=$2, total_earned=$3, state_revision=state_revision+1, updated_at=NOW()
       WHERE chat_id=$1 RETURNING state_revision`, [chatId, r.balance, r.total_earned]);
...
const gameAttemptFallbackSecret = crypto_1.default.randomBytes(32).toString("hex");
const GAME_ATTEMPT_KEY = crypto_1.default.createHmac("sha256", "KotikKombatGameAttempt")
    .update(process.env.CLICKER_GAME_ATTEMPT_SECRET || process.env.BOT_TOKEN || gameAttemptFallbackSecret)
    .digest();
function signGameAttempt(payload) {
    return crypto_1.default.createHmac("sha256", GAME_ATTEMPT_KEY).update(payload).digest("base64url");
}
function createGameAttempt(chatId, game) {
    if (game !== "rain" && !GAME_CFG[game])
        return { ok: false, reason: "bad_game" };
    const body = { c: String(chatId), g: game, t: Date.now(), n: crypto_1.default.randomBytes(9).toString("base64url") };
    const encoded = Buffer.from(JSON.stringify(body), "utf8").toString("base64url");
    return { ok: true, token: `${encoded}.${signGameAttempt(encoded)}` };
}
function gameAttemptDay(timestamp) {
    return new Date(timestamp + 8 * 3600 * 1000).toISOString().slice(0, 10);
}
function dailyClaimRejection(storedDay, attemptDay) {
    if (typeof storedDay !== "string" || !storedDay)
        return null;
    if (storedDay === attemptDay)
        return "already";
...
function consumeGameAttempt(chatId, game, token) {
    if (!token || typeof token !== "string")
        return { ok: false, reason: "missing_attempt" };
    if (token.length > 500)
        return { ok: false, reason: "bad_attempt" };
    const parts = token.split(".");
    if (parts.length !== 2)
        return { ok: false, reason: "bad_attempt" };
    const expected = signGameAttempt(parts[0]);
    const gotBuf = Buffer.from(parts[1], "utf8"), expectedBuf = Buffer.from(expected, "utf8");
    if (gotBuf.length !== expectedBuf.length || !crypto_1.default.timingSafeEqual(gotBuf, expectedBuf))
        return { ok: false, reason: "bad_attempt" };
    let a;
    try {
        a = JSON.parse(Buffer.from(parts[0], "base64url").toString("utf8"));
    }
    catch {
        return { ok: false, reason: "bad_attempt" };
    }
    if (a.c !== String(chatId) || a.g !== game || !Number.isFinite(a.t))
        return { ok: false, reason: "bad_attempt" };
    const elapsed = Date.now() - a.t;
    if (elapsed < 0)
        return { ok: false, reason: "bad_attempt" };
    if (elapsed > GAME_ATTEMPT_TTL_MS)
        return { ok: false, reason: "expired_attempt" };
    if (elapsed < (GAME_ATTEMPT_MIN_MS[game] || 0))
...
async function claimRain(chatId, score, attemptToken = "") {
    ...
    try {
        ...
        void score;
        const reward = Math.min(8000, 1500 + lvl * 500);
        r.balance = Number(r.balance) + reward;
        r.total_earned = Number(r.total_earned) + reward;
        r.rain_date = today;
...
const GAME_CFG = {
    quiz_kids: { reward: 2500 },
    quiz_riddle: { reward: 2400 },
    count: { reward: 1200 },
    memory: { reward: 3000 },
    gems: { reward: 4500 },
    tower: { reward: 6000 },
};
function gameParticipationReward(game) { return GAME_CFG[game]?.reward ?? 0; }
async function claimGame(chatId, game, score, attemptToken = "") {
...
function rollChest(level) {
    const r = Math.random();
    const sc = 1 + level * 0.25;
    if (r < 0.42)
        return { type: "coins", amount: Math.round((300 + Math.random() * 1000) * sc) };
    if (r < 0.68)
        return { type: "coins", amount: Math.round((1200 + Math.random() * 2500) * sc) };
    if (r < 0.82)
        return { type: "turbo" };
    if (r < 0.95)
        return { type: "energy" };
...
async function openChest(chatId) {
    const client = await db_1.pool.connect();
    try {
        await client.query("BEGIN");
        const { r, cl } = await refresh(client, chatId);
        const today = irkToday();
        if (r.chest_date === today) {
            await client.query("ROLLBACK");
            return { ok: false, reason: "already" };
        }
        ...
        if (prize.type === "coins" || prize.type === "jackpot") {
            r.balance = Number(r.balance) + (prize.amount || 0);
            r.total_earned = Number(r.total_earned) + (prize.amount || 0);
        }
            ...
            r.energy = (0, exports.energyMaxFor)(r.energy_limit_level);
            r.energy_carry = 0;
        }
        r.chest_date = today;
        await client.query(`UPDATE clicker_state SET balance=$2, total_earned=$3, energy=$4, turbo_until=$5, chest_date=$6, energy_carry=$7, updated_at=NOW() WHERE chat_id=$1`, [chatId, r.balance, r.total_earned, r.energy, r.turbo_until || null, today, Number(r.energy_carry || 0)]);
...
exports.CASE_DAILY_ROLL_LIMIT = Math.max(1, Number(process.env.CASE_DAILY_ROLL_LIMIT || 10));
async function openCase(chatId, requestId) {
    const { CASE_COST, canGrantCaseBusinessLevel, rollCase, prizeValue, protectCaseLossStreak } = await Promise.resolve().then(() => __importStar(require("./lootbox")));
    const { grantPigeon, pickBreedOfRarity } = await Promise.resolve().then(() => __importStar(require("./pigeons")));
    const client = await db_1.pool.connect();
    try {
        await client.query("BEGIN");
        const { r, cl } = await refresh(client, chatId);
        const previous = await client.query(`SELECT prize, balance_before, balance_after FROM clicker_case_history WHERE chat_id=$1 AND request_id=$2`, [chatId, requestId]);
        if (previous.rowCount) {
            await client.query("COMMIT");
            return { ok: true, prize: previous.rows[0].prize, state: buildState(r, cl, 0), newBalance: Number(previous.rows[0].balance_after), balanceBefore: Number(previous.rows[0].balance_before), cost: CASE_COST, duplicate: true };
        }
        const rollCount = await client.query(`SELECT COUNT(*)::text AS count FROM clicker_case_history WHERE chat_id=$1 AND (created_at AT TIME ZONE 'Asia/Irkutsk')::date = $2::date`, [chatId, irkToday()]);
        const caseRollsToday = Number(rollCount.rows[0]?.count || 0);
        if (caseRollsToday >= exports.CASE_DAILY_ROLL_LIMIT) {
            await client.query("ROLLBACK");
            return { ok: false, reason: "case_limit", caseRollsToday, caseDailyLimit: exports.CASE_DAILY_ROLL_LIMIT };
        }
        if (Number(r.balance) < CASE_COST) {
            await client.query("ROLLBACK");
        ...
        if (prize.type === "coins") {
        ...
        else if (prize.type === "pigeon") {
            const breed = pickBreedOfRarity(prize.rarity, Math.random());
            pigeonDrop = await grantPigeon(chatId, breed, client);
            out.rarity = prize.rarity;
            out.breed = breed;
            out.isNew = pigeonDrop.isNew;
            out.marketValue = prizeValue(prize);
        }
        else if (prize.type === "business") {
            const card = CARD_BY_ID[prize.id];
            if (!card)
                throw new Error(`Unknown case business: ${prize.id}`);
            const level = Number(cl[prize.id] || 0);
            const marketValue = (0, exports.cardPrice)(card, level);
            if (!canGrantCaseBusinessLevel(marketValue)) {
                ...
                out.businessId = prize.id;
                out.businessName = card.name;
        ...
        await client.query(`UPDATE clicker_state SET balance=$2, total_earned=$3, energy=$4, turbo_until=$5, case_spent=case_spent+$6, case_won=case_won+$7, case_dry=$8, energy_carry=$9, updated_at=NOW() WHERE chat_id=$1`, [chatId, r.balance, r.total_earned, r.energy, r.turbo_until || null, CASE_COST, won, newDry, Number(r.energy_carry || 0)]);
        await client.query(`INSERT INTO clicker_case_history (chat_id, request_id, cost, prize, balance_before, balance_after) VALUES ($1,$2,$3,$4,$5,$6)`, [chatId, requestId, CASE_COST, JSON.stringify(out), balanceBefore, r.balance]);
        await syncPigeonModifiersAfterDrop(r, chatId, pigeonDrop, client);
        await client.query("COMMIT");
        return { ok: true, prize: out, state: buildState(r, cl, 0), newBalance: Number(r.balance), balanceBefore, cost: CASE_COST, pigeonDrop, caseRollsToday: caseRollsToday + 1, caseDailyLimit: exports.CASE_DAILY_ROLL_LIMIT };
    }
    catch (e) {
        await client.query("ROLLBACK").catch(() => { });
        throw e;
...
async function claimBonus(chatId) {
    const client = await db_1.pool.connect();
    try {
        await client.query("BEGIN");
        const { r, cl } = await refresh(client, chatId);
        if (r.bonus_at && Date.now() - new Date(r.bonus_at).getTime() < BONUS_COOLDOWN_MS) {
            await client.query("ROLLBACK");
        ...
        r.total_earned = Number(r.total_earned) + amount;
...
async function boostClicker(chatId, type) {
    const client = await db_1.pool.connect();
    try {
        await client.query("BEGIN");
        const { r, cl } = await refresh(client, chatId);
        if (type === "energy") {
            if (r.boost_energy_used >= DAILY_BOOSTS) {
                await client.query("ROLLBACK");
                return { ok: false, reason: "no_boosts" };
            }
            if (Number(r.energy) >= (0, exports.energyMaxFor)(r.energy_limit_level)) {
                await client.query("ROLLBACK");
                return { ok: false, reason: "full_energy" };
            }
            r.energy = (0, exports.energyMaxFor)(r.energy_limit_level);
            r.energy_carry = 0;
            r.boost_energy_used += 1;
            ...
            if (r.boost_turbo_used >= DAILY_BOOSTS) {
                await client.query("ROLLBACK");
                return { ok: false, reason: "no_boosts" };
            }
            if (r.turbo_until && new Date(r.turbo_until).getTime() > Date.now()) {
                await client.query("ROLLBACK");
                return { ok: false, reason: "already_active" };
            }
            r.turbo_until = new Date(Date.now() + TURBO_SEC * 1000);
            r.boost_turbo_used += 1;
...
async function getTop(chatId, limit = 30) {
    const cur = (0, exports.weekKey)();
    const { rows } = await db_1.pool.query(`SELECT c.chat_id, (c.total_earned - c.week_base) AS pts, c.prestige, c.album_bonus, s.first_name, s.username
    ...
    const showcaseByChat = new Map();
    if (topIds.length) {
        const sc = await db_1.pool.query(`SELECT chat_id, breed, stars, showcase FROM pigeon_inventory WHERE chat_id = ANY($1) AND showcase > 0 ORDER BY showcase`, [topIds]);
        for (const s of sc.rows) {
            const cid = Number(s.chat_id);
            let list = showcaseByChat.get(cid);
            if (!list) {
                list = [];
                showcaseByChat.set(cid, list);
            }
            if (list.length < 3)
                list.push({ breed: String(s.breed), stars: Number(s.stars) });
        }
    }
    ...
    const me = await db_1.pool.query(`SELECT week_key, (total_earned - week_base) AS pts FROM clicker_state WHERE chat_id=$1`, [chatId]);
    ...
    const rank = await db_1.pool.query(`SELECT COUNT(*)::int AS n FROM clicker_state
      WHERE week_key=$2
        AND admin_blocked=FALSE
        AND ((total_earned - week_base) > $1
          OR ((total_earned - week_base) = $1 AND chat_id < $3))`, [myPts, cur, chatId]);
    // прошлая неделя — победители топ-3 (для соц-доказательства + «приз недели»)
    const lwKey = String(weekMonday() - 7);
    const lw = await db_1.pool.query(`SELECT w.rank, w.chat_id, w.points, s.first_name, s.username
    ...
    return {
        ...
        weekly: { enabled: exports.WEEKLY_PRIZES_ENABLED, prizes: exports.WEEKLY_PRIZES, lastWeek },
    };
}
/**
 ...
 */
async function closeWeeklySeason() {
    ...
    await db_1.pool.query(`WITH scores AS (
     ...
     SELECT $1, squad, SUM(points)::bigint
      ...
      GROUP BY squad
     ON CONFLICT (week, squad) DO NOTHING`, [endedKey]).catch((e) => logger_1.log.warn({ err: e }, "[weekly] squad stats snapshot"));
    ...
    const prizePoints = (rank) => exports.WEEKLY_PRIZES_ENABLED ? Number(WEEKLY_PRIZE_BY_RANK[rank]?.points || 0) : 0;
    const inserted = await db_1.pool.query(`WITH scores AS (
     ...
     RETURNING rank`, [endedKey, prizePoints(1), prizePoints(2), prizePoints(3)]);
    const recorded = inserted.rowCount ?? 0;
    const awarded = exports.WEEKLY_PRIZES_ENABLED ? await awardPendingWeeklyPrizes(endedKey) : 0;
    if (!recorded && !awarded)
        logger_1.log.info({ endedKey }, "[weekly] no new winners or already closed");
    logger_1.log.info({ endedKey, recorded, awarded, enabled: exports.WEEKLY_PRIZES_ENABLED }, "[weekly] season closed");
    return { week: endedKey, recorded, awarded };
}
/** Продолжает частично завершённые выдачи; earnPoints дедупится постоянным ключом. */
async function awardPendingWeeklyPrizes(week) {
    if (!exports.WEEKLY_PRIZES_ENABLED)
        return 0;
    const pending = await db_1.pool.query(`SELECT rank, chat_id, prize_points FROM clicker_week_winners
    ...
    for (const row of pending.rows) {
        ...
        if (!(await (0, club_1.isPhoneVerified)(chatId).catch(() => false)))
            continue;
        try {
            await (0, club_1.earnPoints)(chatId, points, "clicker_weekly_top", { rank, week }, `clicker-weekly:${week}:${rank}`);
            const marked = await db_1.pool.query(`UPDATE clicker_week_winners SET awarded=TRUE WHERE week_key=$1 AND rank=$2 AND awarded=FALSE`, [week, rank]);
            if ((marked.rowCount ?? 0) > 0)
                awarded++;
        }
        catch (e) {
            logger_1.log.warn({ err: e, week, rank, chatId }, "[weekly] prize award failed; will retry");
        }
    }
    return awarded;
}
 ...
 */
async function pushWeeklyWinners(push) {
    if (!exports.WEEKLY_PRIZES_ENABLED)
        return { sent: 0 };
    const endedKey = String(weekMonday() - 7);
    await awardPendingWeeklyPrizes(endedKey);
    const { rows } = await db_1.pool.query(`SELECT rank, chat_id, prize_points, awarded FROM clicker_week_winners WHERE week_key=$1 AND pushed=FALSE ORDER BY rank`, [endedKey]);
    let sent = 0;
    for (const r of rows) {
        const chatId = Number(r.chat_id), rank = Number(r.rank);
        const medal = rank === 1 ? "🥇" : rank === 2 ? "🥈" : "🥉";
        const prize = WEEKLY_PRIZE_BY_RANK[rank];
        const link = (0, links_1.miniAppLink)(chatId, "click");
        ...
        if (ok) {
            await db_1.pool.query(`UPDATE clicker_week_winners SET pushed=TRUE WHERE week_key=$1 AND rank=$2`, [endedKey, rank]);
            sent++;
        }
    }
    if (sent)
        logger_1.log.info({ endedKey, sent }, "[weekly] winners notified");
    return { sent };
}
...
exports.SQUAD_BANK_MULT = 1.25;
exports.SQUAD_BANK_MIN_DONATE = 100;
exports.SQUAD_BANK_DAY_CAP = 50000; // вклад одного игрока в день
...
exports.SQUAD_BANK_TARGET_PCT = 0.15;
exports.SQUAD_BANK_TARGET_FLOOR = 20000;
exports.SQUAD_BANK_TARGET_CAP = 2000000;
/** Цель недели от заработка стаи за прошлую неделю — чистая, для юнит-тестов. */
function squadBankTargetFrom(lastWeekEarned) {
    const raw = Math.round(Math.max(0, lastWeekEarned) * exports.SQUAD_BANK_TARGET_PCT);
    return Math.min(exports.SQUAD_BANK_TARGET_CAP, Math.max(exports.SQUAD_BANK_TARGET_FLOOR, raw));
}
/** Сколько игрок может вложить сейчас — чистая, для юнит-тестов. */
function squadBankClamp(balance, donatedToday, want) {
    const room = Math.max(0, exports.SQUAD_BANK_DAY_CAP - Math.max(0, donatedToday));
    const amount = Math.min(Math.floor(want), Math.floor(balance), room);
    return amount >= exports.SQUAD_BANK_MIN_DONATE ? amount : 0;
}
async function initSquadBankSchema() {
    await db_1.pool.query(`
...
async function lastWeekSquadEarned(squad, db = db_1.pool) {
...
async function squadBankSum(squad, db = db_1.pool) {
    const { rows } = await db.query(`SELECT COALESCE(SUM(b.total),0) AS s
       FROM clicker_squad_bank b
       JOIN clicker_state c ON c.chat_id=b.chat_id AND c.admin_blocked=FALSE
      WHERE b.week=$1 AND b.squad=$2`, [(0, exports.weekKey)(), squad]);
    return Number(rows[0].s);
}
async function squadBankStatus(squad, chatId) {
    const wk = (0, exports.weekKey)();
    const [sum, lastEarned, mine, top] = await Promise.all([
        squadBankSum(squad),
        lastWeekSquadEarned(squad),
        chatId
            ? db_1.pool.query(`SELECT total, today, today_key FROM clicker_squad_bank WHERE week=$1 AND squad=$2 AND chat_id=$3`, [wk, squad, chatId])
            : Promise.resolve({ rows: [] }),
        // Топ-3 вкладчиков с именами — признание в UI (display-only)
        db_1.pool.query(`SELECT b.chat_id, b.total, COALESCE(NULLIF(sub.first_name,''), NULLIF(sub.username,''), 'Игрок') AS name
         FROM clicker_squad_bank b
         JOIN clicker_state c ON c.chat_id=b.chat_id AND c.admin_blocked=FALSE
    ...
    const myToday = my && my.today_key === (0, exports.todayIrkutsk)() ? Number(my.today) : 0;
    return {
        target, sum, reached: sum >= target, mult: exports.SQUAD_BANK_MULT,
        myTotal: Number(my?.total || 0), myToday, dayCap: exports.SQUAD_BANK_DAY_CAP, minDonate: exports.SQUAD_BANK_MIN_DONATE,
...
let _clickerPushSvc = null;
function setClickerPushService(p) { _clickerPushSvc = p; }
async function squadDisplayName(squad) {
    const std = exports.SQUADS.find((s) => s.id === squad);
    if (std)
        return std.name;
    const { rows } = await db_1.pool.query(`SELECT name FROM squads WHERE id=$1`, [squad]);
    return String(rows[0]?.name || "стая");
}
function notifySquadGoalReached(squad, mult) {
    ...
    void (async () => {
        try {
            ...
            const { rows } = await db_1.pool.query(`SELECT chat_id FROM clicker_state WHERE squad=$1 AND admin_blocked=FALSE`, [squad]);
            for (const row of rows) {
                await push.sendRaw(Number(row.chat_id), `🏆 Стая «${name}» наполнила копилку!\nВесь доход ×${mult} до конца недели — тапайте на полную 🐱`, { parse_mode: "Markdown", dedupeKey: `squad-bank:${(0, exports.weekKey)()}:${squad}` }).catch(() => { });
                await new Promise((r) => setTimeout(r, 60));
            }
            logger_1.log.info({ squad, members: rows.length }, "[squad-bank] goal push sent");
        }
        catch (e) {
            logger_1.log.warn({ err: e, squad }, "[squad-bank] goal push");
        }
    })();
}
async function donateSquadBank(chatId, want, requestId = "") {
    const client = await db_1.pool.connect();
    ...
    try {
        ...
        if (rid) {
            ...
            const previous = await client.query(`SELECT squad, amount FROM clicker_squad_bank_runs WHERE chat_id=$1 AND request_id=$2`, [chatId, rid]);
            if (previous.rowCount) {
        ...
        const wk = (0, exports.weekKey)(), today = (0, exports.todayIrkutsk)();
        const cur = await client.query(`SELECT total, today, today_key FROM clicker_squad_bank WHERE week=$1 AND squad=$2 AND chat_id=$3 FOR UPDATE`, [wk, squad, chatId]);
        ...
        if (!amount) {
            await client.query("ROLLBACK");
            return { ok: false, reason: donatedToday >= exports.SQUAD_BANK_DAY_CAP ? "day_cap" : "bad_amount" };
        }
        r.balance = Number(r.balance) - amount;
        const updated = await client.query(`UPDATE clicker_state SET balance=$2, state_revision=state_revision+1, updated_at=NOW() WHERE chat_id=$1 RETURNING state_revision`, [chatId, r.balance]);
        r.state_revision = Number(updated.rows[0]?.state_revision || r.state_revision || 0);
        await client.query(`INSERT INTO clicker_squad_bank (week, squad, chat_id, total, today, today_key)
       VALUES ($1,$2,$3,$4,$4,$5)
       ON CONFLICT (week, squad, chat_id) DO UPDATE SET
         ...
         today_key = $5`, [wk, squad, chatId, amount, today]);
        if (rid) {
            await client.query(`INSERT INTO clicker_squad_bank_runs (chat_id, request_id, week, squad, amount) VALUES ($1,$2,$3,$4,$5)`, [chatId, rid, wk, squad, amount]);
        }
        await client.query("COMMIT");
        client.release();
        clientReleased = true;
        _bankCache.delete(`${wk}:${squad}`); // бафф мог включиться прямо этим вкладом
        (0, analytics_1.trackEvent)(chatId, "squad_bank", { squad, amount });
        ...
        if (bank.reached)
            r.__bankMult = exports.SQUAD_BANK_MULT;
        // Именно этот вклад закрыл цель → событие для всей стаи (пуш в фоне)
        if (bank.reached && bank.sum - amount < bank.target)
            notifySquadGoalReached(squad, bank.mult);
...
function _clearSquadBankCache() { _bankCache.clear(); }
async function squadBankActive(squad, db = db_1.pool) {
    if (!squad)
        return false;
    const key = `${(0, exports.weekKey)()}:${squad}`;
    ...
    if (_bankCache.size > 10000) {
        const cutoff = Date.now() - 2 * 60000;
        for (const [k, v] of _bankCache)
            if (v.ts < cutoff)
                _bankCache.delete(k);
        if (_bankCache.size > 10000)
            _bankCache.delete(_bankCache.keys().next().value);
    }
    return reached;
}
// ── Свои стаи (08.2026) ─────────────────────────────────────────────────────
...
exports.SQUAD_CREATE_COST = 25000;
exports.SQUAD_MAX_MEMBERS = 20;
exports.SQUAD_NAME_MIN = 3;
exports.SQUAD_NAME_MAX = 20;
 ...
 */
function sanitizeSquadName(raw) {
    const name = String(raw || "").replace(/\s+/g, " ").trim();
    if (name.length < exports.SQUAD_NAME_MIN || name.length > exports.SQUAD_NAME_MAX)
        return null;
    if (!/^[а-яёА-ЯЁa-zA-Z0-9 \-_!?.«»]+$/.test(name))
        return null;
    if (!/[а-яёА-ЯЁa-zA-Z0-9]/.test(name))
        return null;
    if (SQUAD_NAME_STOP.test(name.toLowerCase().replace(/[^а-яёa-z]/g, "")))
        return null;
    if (exports.SQUADS.some((s) => s.name.toLowerCase() === name.toLowerCase()))
        return null;
    return name;
}
async function initCustomSquadSchema() {
    await db_1.pool.query(`
...
const genSquadId = () => "c" + crypto_1.default.randomBytes(4).toString("hex");
const genInviteCode = () => crypto_1.default.randomBytes(4).toString("base64url").replace(/[-_]/g, "x").slice(0, 6).toUpperCase();
async function squadMemberCount(id, db = db_1.pool) {
    const { rows } = await db.query(`SELECT COUNT(*)::int AS n FROM clicker_state WHERE squad=$1 AND admin_blocked=FALSE`, [id]);
    return Number(rows[0].n);
}
async function createSquad(chatId, rawName) {
    ...
    try {
        ...
        if (Number(r.balance) < exports.SQUAD_CREATE_COST) {
            await client.query("ROLLBACK");
        ...
        await client.query(`UPDATE clicker_state SET balance = balance - $2, squad = $3, updated_at = NOW() WHERE chat_id = $1`, [chatId, exports.SQUAD_CREATE_COST, id]);
        await client.query(`DELETE FROM squad_requests WHERE chat_id=$1`, [chatId]);
        await client.query("COMMIT");
        (0, analytics_1.trackEvent)(chatId, "squad_create", { id, name });
    }
    catch (e) {
        await client.query("ROLLBACK").catch(() => { });
        throw e;
...
async function joinSquadByCode(chatId, rawCode) {
    ...
    try {
        ...
        const { r } = await refresh(client, chatId);
        if (r.squad !== squadId && (await squadMemberCount(squadId, client)) >= exports.SQUAD_MAX_MEMBERS) {
            await client.query("ROLLBACK");
            return { ok: false, reason: "full" };
        }
        await client.query(`UPDATE clicker_state SET squad=$2, state_revision=state_revision+1, updated_at=NOW() WHERE chat_id=$1`, [chatId, squadId]);
        await client.query(`DELETE FROM squad_requests WHERE chat_id=$1`, [chatId]);
        await client.query("COMMIT");
    }
    catch (e) {
    ...
    (0, analytics_1.trackEvent)(chatId, "squad_join_code", { id: squadId });
    return { ok: true, squadName, state: await getClicker(chatId) };
}
async function requestJoinSquad(chatId, squadId) {
    ...
    try {
        ...
        if ((await squadMemberCount(squadId, client)) >= exports.SQUAD_MAX_MEMBERS) {
            await client.query("ROLLBACK");
            return { ok: false, reason: "full" };
        }
        await client.query(`DELETE FROM squad_requests WHERE chat_id=$1 AND squad_id<>$2`, [chatId, squadId]);
        await client.query(`INSERT INTO squad_requests (squad_id, chat_id) VALUES ($1,$2) ON CONFLICT DO NOTHING`, [squadId, chatId]);
        await client.query("COMMIT");
    }
    catch (e) {
        await client.query("ROLLBACK").catch(() => { });
    ...
    (0, analytics_1.trackEvent)(chatId, "squad_request", { id: squadId });
    return { ok: true, pending: true };
}
/** Заявки в МОЮ стаю (я — владелец). */
async function listSquadRequests(ownerId) {
    const own = await db_1.pool.query(`SELECT id FROM squads WHERE owner_chat_id=$1`, [ownerId]);
    if (!own.rows[0])
        return { squadId: null, requests: [] };
    const squadId = own.rows[0].id;
    const { rows } = await db_1.pool.query(`SELECT r.chat_id, r.created_at, COALESCE(sub.first_name, sub.username, '') AS name,
...
async function decideSquadRequest(ownerId, applicantId, accept) {
    const client = await db_1.pool.connect();
    let squadId = "";
    try {
        await client.query("BEGIN");
        ...
        squadId = own.rows[0].id;
        await client.query(`SELECT pg_advisory_xact_lock(hashtextextended($1, 0))`, [`squad-member:${applicantId}`]);
        const request = await client.query(`SELECT 1 FROM squad_requests WHERE squad_id=$1 AND chat_id=$2 FOR UPDATE`, [squadId, applicantId]);
        if (!request.rows[0]) {
            await client.query("ROLLBACK");
        ...
        const applicantState = await client.query(`SELECT admin_blocked FROM clicker_state WHERE chat_id=$1 FOR UPDATE`, [applicantId]);
        ...
        await client.query(`UPDATE clicker_state SET squad=$2, state_revision=state_revision+1, updated_at=NOW() WHERE chat_id=$1`, [applicantId, squadId]);
    ...
    (0, analytics_1.trackEvent)(applicantId, "squad_accepted", { id: squadId, by: ownerId });
    return { ok: true };
}
/** Команды: рейтинг по сумме намолоченного (стандартные + свои), выбор/смена. */
async function getSquads(chatId) {
    const [agg0, custom, me, own, pending] = await Promise.all([
        db_1.pool.query(`SELECT squad,
        ...
        db_1.pool.query(`SELECT id, name, owner_chat_id, invite_code FROM squads`),
        db_1.pool.query(`SELECT squad FROM clicker_state WHERE chat_id=$1`, [chatId]),
        db_1.pool.query(`SELECT s.id, s.name, s.invite_code, (SELECT COUNT(*)::int FROM squad_requests r WHERE r.squad_id = s.id) AS req
                  FROM squads s WHERE s.owner_chat_id=$1`, [chatId]),
        db_1.pool.query(`SELECT squad_id FROM squad_requests WHERE chat_id=$1 LIMIT 1`, [chatId]),
    ]);
    const agg = {};
    for (const r of agg0.rows)
        agg[r.squad] = { pts: Number(r.pts), n: r.n };
    const mySquad = (me.rows[0] && me.rows[0].squad) || null;
    const list = [
        ...exports.SQUADS.map((s) => ({ id: s.id, name: s.name, custom: false })),
...
async function getSquadMembers(chatId) {
    const meRow = await db_1.pool.query(`SELECT squad FROM clicker_state WHERE chat_id=$1`, [chatId]);
    const squad = (meRow.rows[0] && meRow.rows[0].squad) || null;
    if (!squad)
        return { inSquad: false, name: "", members: [] };
    const wk = (0, exports.weekKey)();
    const preset = exports.SQUADS.find((s) => s.id === squad);
    let name = preset ? preset.name : squad;
    if (!preset) {
        const n = await db_1.pool.query(`SELECT name FROM squads WHERE id::text=$1`, [squad]);
        if (n.rows[0])
            name = String(n.rows[0].name);
    }
    const rows = await db_1.pool.query(`SELECT cs.chat_id, cs.total_earned, s.first_name, s.username, COALESCE(b.total,0) AS bank
...
async function joinSquad(chatId, squadId) {
    if (!SQUAD_IDS.has(squadId))
        return { ok: false, reason: "bad_squad" };
    const client = await db_1.pool.connect();
    try {
        await client.query("BEGIN");
        await client.query(`SELECT pg_advisory_xact_lock(hashtextextended($1, 0))`, [`squad-member:${chatId}`]);
...
function isReferralEligibleState(totalEarned, taps, referredBy) {
    const earned = Number(totalEarned);
    const tapCount = Number(taps);
    return referredBy == null && Number.isFinite(earned) && earned >= 0 && earned <= 5000
        && Number.isFinite(tapCount) && tapCount >= 0 && tapCount <= 10;
}
async function registerRef(chatId, code) {
    const rawRefId = Number(code);
    const noop = async () => ({ ok: false, state: await getClicker(chatId) });
    if (!Number.isSafeInteger(rawRefId) || rawRefId <= 0)
        return noop();
    const refId = await (0, account_link_1.canonicalChatId)(rawRefId);
    if (refId === chatId)
        return noop();
    const client = await db_1.pool.connect();
    ...
    try {
        ...
        if (!referrer.rowCount) {
            ...
            if (!isReferralEligibleState(invitee.total_earned, invitee.taps, invitee.referred_by)) {
                ...
                await client.query(`UPDATE clicker_state SET referred_by=$2, balance=balance+$3, total_earned=total_earned+$3,
             state_revision=state_revision+1, updated_at=NOW() WHERE chat_id=$1`, [chatId, refId, REF_INVITEE]);
                await client.query(`UPDATE clicker_state SET balance=balance+$2, total_earned=total_earned+$2,
             referrals=referrals+1, state_revision=state_revision+1, updated_at=NOW() WHERE chat_id=$1`, [refId, REF_REFERRER]);
                await client.query("COMMIT");
                registered = true;
            }
        }
...
async function getRefOrderCandidates() {
    const { rows } = await db_1.pool.query(`SELECT chat_id, referred_by FROM clicker_state
      WHERE referred_by IS NOT NULL AND ref_order_rewarded = FALSE`);
    return rows.map((r) => ({ invitee: Number(r.chat_id), referrer: Number(r.referred_by) }));
}
/** T4: пометить, что реф-бонус за первый заказ приглашённого выдан (идемпотентно). */
async function markRefOrderRewarded(invitee) {
    const { rowCount } = await db_1.pool.query(`UPDATE clicker_state SET ref_order_rewarded = TRUE
      WHERE chat_id = $1 AND ref_order_rewarded = FALSE`, [invitee]);
    return (rowCount ?? 0) > 0;
}
/** T5: показывался ли уже welcome-промокод игроку. */
async function welcomePromoShown(chatId) {
    const { rows } = await db_1.pool.query(`SELECT welcome_promo_at FROM clicker_state WHERE chat_id = $1`, [chatId]);
...
async function markWelcomePromoShown(chatId) {
    const { rowCount } = await db_1.pool.query(`UPDATE clicker_state SET welcome_promo_at = NOW()
      WHERE chat_id = $1 AND welcome_promo_at IS NULL`, [chatId]);
    return (rowCount ?? 0) > 0;
}
...
async function markOnboarded(chatId) {
    await db_1.pool.query(`UPDATE clicker_state SET onboarded = TRUE WHERE chat_id = $1 AND onboarded = FALSE`, [chatId]);
}
/**
 ...
 */
async function migrateGuest(chatId, _snap) {
...
async function getRewards(chatId) {
    const s = await getClicker(chatId);
    const { rows } = await db_1.pool.query(`SELECT reward_id, cost, code, created_at FROM clicker_redemptions WHERE chat_id=$1 ORDER BY created_at DESC LIMIT 10`, [chatId]);
    return { enabled: exports.REWARDS_ENABLED, balance: s.balance, rewards: exports.REWARDS, history: rows };
}
/**
 ...
 */
async function redeemReward(chatId, id, requestId = "") {
    if (!exports.REWARDS_ENABLED)
        return { ok: false, reason: "disabled" };
    const rw = REWARD_BY_ID[id];
    if (!rw)
        return { ok: false, reason: "bad_reward" };
    const reqKey = String(requestId).trim();
    if (!/^[A-Za-z0-9_-]{16,100}$/.test(reqKey))
    ...
    try {
        await client.query("BEGIN");
        const { r } = await refresh(client, chatId);
        const previous = await client.query(`SELECT id, reward_id, code FROM clicker_redemptions WHERE chat_id=$1 AND request_id=$2 FOR UPDATE`, [chatId, reqKey]);
        if (previous.rows[0]) {
            if (previous.rows[0].reward_id !== id) {
                await client.query("ROLLBACK");
            ...
            const used = await client.query(`SELECT COUNT(*)::int AS n FROM clicker_redemptions
          WHERE chat_id=$1 AND code <> 'FAILED' AND created_at > NOW() - INTERVAL '1 day'`, [chatId]);
            if (Number(used.rows[0].n) >= REDEEM_PER_DAY) {
                await client.query("ROLLBACK");
                return { ok: false, reason: "daily_limit" };
            }
            if (Number(r.balance) < rw.cost) {
                await client.query("ROLLBACK");
                return { ok: false, reason: "not_enough" };
            }
            const inserted = await client.query(`INSERT INTO clicker_redemptions (chat_id, reward_id, cost, code, request_id)
         VALUES ($1,$2,$3,'PENDING',$4) RETURNING id`, [chatId, id, rw.cost, reqKey]);
    ...
    if (settledCode && settledCode !== "PENDING") {
        if (settledCode === "FAILED")
            return { ok: false, reason: "grant_failed", state: await getClicker(chatId) };
    ...
    try {
        if (rw.kind === "loyalty") {
            await (0, club_1.earnPoints)(chatId, rw.points, "clicker_redeem", { reward: id }, sourceKey);
            finalCode = `POINTS:${rw.points}`;
        }
        else {
            const grant = await (0, club_1.grantRewardByCode)(chatId, rw.catalog, sourceKey);
            if (!grant.ok || !grant.promoCode)
                throw new Error(grant.reason || "grant_failed");
            finalCode = grant.promoCode;
        }
    }
    catch (e) {
        const refund = await db_1.pool.connect();
        try {
            ...
            logger_1.log.error({ err: refundError, redemptionId }, "[redeem refund failed]");
            throw refundError;
        }
        finally {
            refund.release();
        }
        logger_1.log.warn({ err: e, redemptionId }, "[redeem grant failed]");
        return { ok: false, reason: "grant_failed" };
    }
    await db_1.pool.query(`UPDATE clicker_redemptions SET code=$2 WHERE id=$1 AND code='PENDING'`, [redemptionId, finalCode]);
 ...
 */
async function addClickerBalance(chatId, coins, client) {
    const MAX_SINGLE_INTERNAL_GRANT = 10000000;
    if (!Number.isFinite(coins) || coins <= 0)
        return;
    const n = Math.min(MAX_SINGLE_INTERNAL_GRANT, Math.round(coins));
    if (n <= 0)
        return;
    const credit = async (q) => {
        await refresh(q, chatId);
        await q.query(`UPDATE clicker_state SET balance = balance + $2, total_earned = total_earned + $2,
         state_revision = state_revision + 1, updated_at = NOW() WHERE chat_id=$1`, [chatId, n]);
    };
    if (client) {
        await credit(client);
        return;
    }
    const own = await db_1.pool.connect();
    try {
...
function taskClaimable(t, s) {
    ...
    if (t.type === "level")
        return s.level >= t.target || s.prestige > 0;
    if (t.type === "balance")
        return s.totalEarned >= t.target || s.prestige > 0;
    if (t.type === "streak")
        return s.dailyStreak >= t.target;
    if (t.type === "ref")
        return s.referrals >= t.target;
    if (t.type === "taps")
        return s.taps >= t.target;
    if (t.type === "cards")
        return s.cardsOwned >= t.target;
    if (t.type === "collect") {
        if (t.target === "all")
            return s.cards.every((c) => c.level > 0);
...
async function getAchievements(chatId) {
    const s = await getClicker(chatId);
    const { rows } = await db_1.pool.query(`SELECT task FROM clicker_tasks WHERE chat_id=$1`, [chatId]);
    const done = new Set(rows.map((r) => r.task));
    return {
        achievements: exports.ACHIEVEMENTS.map((a) => ({
...
async function getTasks(chatId) {
    ...
    const done = new Set(rows.map((r) => r.task));
    return {
        tasks: exports.TASKS.map((t) => ({
            id: t.id, name: t.name, icon: t.icon, reward: t.reward, type: t.type, link: t.link || null,
            done: done.has(t.id), claimable: !done.has(t.id) && taskClaimable(t, s),
        })),
    };
}
async function claimTask(chatId, id) {
    const t = ALL_BY_ID[id];
    if (!t)
    ...
    try {
        ...
        if (!taskClaimable(t, s)) {
            await client.query("ROLLBACK");
            return { ok: false, reason: "not_ready" };
        }
        r.balance = Number(r.balance) + t.reward;
        r.total_earned = Number(r.total_earned) + t.reward;
...
const MS_BY_ID = Object.fromEntries(exports.MILESTONES.map((m) => [m.id, m]));
// care_streak_best читаем прямым SQL (импорт pet.ts → цикл: pet.ts импортирует addClickerBalance отсюда)
async function getCareStreakBest(chatId) {
    const { rows } = await db_1.pool.query(`SELECT care_streak_best FROM pet_state WHERE chat_id=$1`, [chatId]);
    return Number(rows[0]?.care_streak_best ?? 0);
}
const msReached = (m, s, careBest = 0) => m.cond.type === "care_streak" ? careBest >= m.cond.target
    : taskClaimable({ type: m.cond.type, target: m.cond.target }, s);
async function getMilestones(chatId) {
    const s = await getClicker(chatId);
    const careBest = await getCareStreakBest(chatId).catch(() => 0);
    const gr = await db_1.pool.query(`SELECT achievement, points_granted, perk_granted FROM clicker_gifts WHERE chat_id=$1`, [chatId]);
    const grants = new Map(gr.rows.map((r) => [r.achievement, r]));
    const phoneVerified = await (0, club_1.isPhoneVerified)(chatId).catch(() => false);
    return {
        phoneVerified,
        milestones: exports.MILESTONES.map((m) => ({
...
async function claimMilestone(chatId, id) {
    if (!exports.GIFTS_ENABLED)
        return { ok: false, reason: "disabled" };
    const m = MS_BY_ID[id];
    if (!m)
    ...
    const claim = await db_1.pool.query(`INSERT INTO clicker_gifts (chat_id, achievement, points, points_granted, perk_granted)
     VALUES ($1,$2,$3,$4,$5)
     ON CONFLICT (chat_id, achievement) DO UPDATE SET points=clicker_gifts.points
     RETURNING points_granted, perk_granted, promo_code, perk_title, min_order`, [chatId, id, m.points || 0, !m.points, !m.perk]);
    ...
    if (m.points) {
        if (!row.points_granted) {
            await (0, club_1.earnPoints)(chatId, m.points, "clicker_milestone", { milestone: id }, `clicker-milestone:${chatId}:${id}:points`);
            await db_1.pool.query(`UPDATE clicker_gifts SET points_granted=TRUE WHERE chat_id=$1 AND achievement=$2`, [chatId, id]);
        }
        out.points = m.points;
    }
    if (m.perk) {
        let promoCode = row.promo_code;
        let perkTitle = row.perk_title;
        let minOrder = row.min_order == null ? undefined : Number(row.min_order);
        if (!row.perk_granted) {
            const r = await (0, club_1.grantRewardByCode)(chatId, m.perk, `clicker-milestone:${chatId}:${id}:perk`);
            if (!r.ok)
                throw new Error("grant_failed:" + r.reason);
            promoCode = r.promoCode;
            perkTitle = r.title;
            minOrder = r.minOrder;
            await db_1.pool.query(`UPDATE clicker_gifts SET perk_granted=TRUE, promo_code=$3, perk_title=$4, min_order=$5 WHERE chat_id=$1 AND achievement=$2`, [chatId, id, promoCode || null, perkTitle || null, minOrder ?? null]);
        }
        out.promoCode = promoCode;
        out.perkTitle = perkTitle;
...
const PURCHASE_CAP = 5000000; // потолок одной сверки (защита от выбросов/данных)
...
function computePurchaseGrant(yearSpent, spentSynced) {
...
async function syncPurchaseBonus(chatId) {
    // Атомарно «застолбить» сверку: вставить/обновить last_check, только если прошло >1ч.
    const claim = await db_1.pool.query(`INSERT INTO clicker_purchase_sync (chat_id, last_check) VALUES ($1, NOW())
     ...
     RETURNING spent_synced, last_check`, [chatId]);
    if (!claim.rows.length)
        return { ok: true, granted: 0 }; // троттлинг — сверка была недавно
    ...
    const releaseFailedClaim = async () => {
        await db_1.pool.query(`UPDATE clicker_purchase_sync SET last_check=NULL WHERE chat_id=$1 AND last_check=$2`, [chatId, claimedAt]);
    };
    const lk = await (0, lk_1.fetchLk)(chatId).catch(() => null);
    if (!lk || !lk.ok || !lk.data) {
        ...
        if (!lk || lk.reason !== "phone_not_verified")
            await releaseFailedClaim().catch(() => { });
        return { ok: true, granted: 0 };
    }
    if (!lk.data.configured)
        return { ok: true, granted: 0 };
    ...
    if (grant <= 0) {
        ...
        await db_1.pool.query(`UPDATE clicker_purchase_sync SET spent_synced=$2 WHERE chat_id=$1`, [chatId, yearSpent]);
    ...
    try {
        await client.query("BEGIN");
        const { r, cl } = await refresh(client, chatId);
        r.balance = Number(r.balance) + grant;
        r.total_earned = Number(r.total_earned) + grant;
        ...
        const pigeonDrops = [];
        if (birds > 0) {
            const { pickPurchaseBreed, grantPigeon } = await Promise.resolve().then(() => __importStar(require("./pigeons")));
            for (let i = 0; i < birds; i++) {
                pigeonDrops.push(await grantPigeon(chatId, pickPurchaseBreed(Math.random(), Math.random(), !!activeEvent()), client));
            }
        }
        if (pigeonDrops.some(drop => drop.isNew))
            await syncPigeonModifiersAfterDrop(r, chatId, { isNew: true }, client);
        const st = buildState(r, cl, 0);
        st.gamesDone = await gamesDoneToday(client, chatId);
        await client.query("COMMIT");
