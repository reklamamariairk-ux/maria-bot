...
(function () {
  ...
  function styles() {
    ...
    s.textContent = `
      ...
      .ck-catwrap::before{content:'';position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);width:74%;height:74%;background:radial-gradient(ellipse at center,rgba(255,255,255,.32) 0%,rgba(255,255,255,.16) 40%,rgba(255,255,255,0) 70%);filter:blur(8px);pointer-events:none;z-index:0}
