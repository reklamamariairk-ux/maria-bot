...
const ABOUT_CONTENT = {
  faq: {
    ...
    html: `
      ...
      <p id="faq-sweet-check">Лотерея с призами от кондитерской. Каждый чек даёт билет — чем больше билетов, тем выше шанс выиграть. Список текущих призов смотри в разделе «Клуб → Сладкий чек».</p>
